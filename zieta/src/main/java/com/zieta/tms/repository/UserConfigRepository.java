...
public interface UserConfigRepository extends JpaRepository<UserConfig, Long>{
	...
	List<UserConfig> findByIsDelete(Short notDeleted);
	
	UserConfig findUserConfigByIdAndIsDelete(long id, short isDelete);
	
	Optional<UserConfig> findByUserId(long usreId);
